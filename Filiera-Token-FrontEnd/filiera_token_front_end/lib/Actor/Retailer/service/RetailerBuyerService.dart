...
class RetailerBuyerService {
  ...
  Future<List<Product>> getCheeseBlockList(String wallet) async {
    String url = API.buildURL(API.RetailerBuyerStorage, API.Query, _queryGetCheeseBlockListIDPurchase);
  ...
  Future<Product> getCheeseBlock(String cheeseId, String walletRetailer) async {
    ...
    String url = API.buildURL(API.RetailerBuyerStorage, API.Query, _queryGetCheeseBlock);
