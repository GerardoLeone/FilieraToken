...
        <img src="./images/Presentazione/filiera-token-logo.png" style="width: 50%; display: block; margin: 0 auto;">
        <h3>Obiettivi</h3>
...
        </ul>
    </section>
    <section id="technologies" style="padding: 20px;">
...
        </ul>
    </section>
    <section id="architecture" style="padding: 20px;">
        <h2>Architettura</h2>
...
    </section>
        <footer style="background-color: #333; color: #fff; padding: 20px; text-align: center; position: fixed; bottom: 0; width: 100%;">
